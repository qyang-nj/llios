...
<details>
  <summary>Build MySwiftUIView.1.preview-thunk.swift</summary>
...
<details>
  <summary>Here is the explanation with some code.</summary>
...
``` swift
// The image shows up.
// The code of AStaticLib is from SamplePreview
import SwiftUI
import AStaticLib
...
// The code of AStaticLib is from the *.preview-thunk.dylib
import SwiftUI
import AStaticLib
struct MySwiftUIView_Previews: PreviewProvider {
    static var previews: some View {
